"""
Audio Recording Module (Raspberry Pi)
---------------------------------------
This module identifies available audio devices, allows the user to select a microphone,
records audio chunks, and saves the recordings into the folder specified in the configuration.
"""
...
def main():
    ...
    while True:
        ...
        # Maintain a rolling buffer of the last BUFFER_SIZE chunks.
